...
@section('title', 'ลงเวลา : '. $type_name .' - แก้ไขข้อมูล')

@section('content_header')
    <div class="row">
        <div class="col-md-6">
            <h1 class="m-0 text-dark">
                <i class="fad fa-fw fa-calendar-plus"></i> แก้ไขเวลา : {{$type_name}}
            </h1>
        </div>
        <div class="col-md-6">
...
@section('content')
    <div class="row">
        ...
        <div class="col-md-6">
            <form
                action="{{route('schedules.update',['schedule' => $schedule->id, 'type' => $type])}}" method="post" id="formUpdate" enctype="multipart/form-data">
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            @csrf
                            ...
                            <div class="card-body">
                                <label for="technician_id">พนักงานฝ่ายซ่อมบำรุง <span
                                        class="text-danger">*</span></label>
                                <div class="form-group text-center">
                                    <select class="form-control select2" multiple="multiple" name="technician_id[]" style="width: 100%" id="technician_id">
                                        @foreach($technicians as $technician)
                                            <option @foreach( $schedule->technicianPm as $pm)@if( $pm->technician_id == $technician->id ) selected
                                ...
                                <div class="form-group text-center">
                                    <select class="form-control select2customer" id="customer_id"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text"
                                           ...
                                           name="appointment_date" value="{{$appointment_date}}" id="appointment_date">
                                ...
                                <div class="form-group">
                                    <input autocomplete="nope" type="text"
                                           ...
                                           id="note"
                                           name="note" placeholder="" value="{{$schedule->note}}">
                                    @error('note')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
