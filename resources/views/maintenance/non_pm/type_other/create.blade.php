...
@section('content')
    ...
    <form action="{{route('schedule_others.store')}}" method="post" id="formStore"
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <label for="appointment_date">วันที่ต้องการเข้าซ่อมบำรุง <span
                                ...
                                <div class="form-group text-center">
                                    <input autocomplete="nope" type="text"
                                           ...
                                           id="customer_name"
                                           name="customer_name" placeholder="" value="{{old('customer_name')}}">
                                </div>
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="form-group text-center">
                                            <input autocomplete="nope" type="text"
                                                   ...
                                                   id="product_model"
                                                   name="product_model" placeholder=""
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="form-group text-center">
                                            <input autocomplete="nope" type="text"
                                                   ...
                                                   id="product_number"
                                                   name="product_number" placeholder=""
                                ...
                                <div class="col-md-3">
                                    <div class="form-group clearfix">
                                        <div class="icheck-primary d-inline">
                                            <input type="radio" id="in_progress" name="status_report" value="in_progress" checked />
