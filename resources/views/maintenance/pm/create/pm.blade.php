    ...
    <div class="card-body">
            ...
            <div class="col-md-3">
                ...
                <div class="form-group">
                    <input autocomplete="nope" type="text"
                           class="form-control form-control-sm @error('report_no') is-invalid @enderror"
                           id="report_no" readonly
                           name="report_no" placeholder=""
                           value="{{ $maintenance->round_pm . '/' . $maintenance->agreement->contract}}">
                    @error('report_no')
        ...
        <div class="row">
            ...
            <div class="col-sm-3">
                ...
                <div class="form-group text-center">
                    <input autocomplete="nope" type="text"
                           class="form-control form-control-sm @error('serial_name') is-invalid @enderror"
                            ...
                            <tr>
                                ...
                                <td>
                                    <input autocomplete="nope" type="text"
                                           ...
                                           id="result"
                                           name="result[]" placeholder="" value="{{old('result')}}">
                                </td>
                            </tr>
                        @endforeach
                        </tbody>
                            ...
                            <script>
                                $('.present').keyup(function () {
                                    $('.present').each(function () {
                                        ...
                                        var limit = currentRow.find('input[name="limit_value"]').val();
                                        console.log(limit);
                                        if (value > limit) {
                                            obj.css({"border": "red solid 1.5px"});
                                        } else {
                        ...
                        <tr>
                            ...
                            <td>
                                <input autocomplete="nope" type="text"
                                       ...
                                       id="running"
                                       name="running" placeholder="" value="{{old('running')}}">
                            </td>
                            <td rowspan="2">
                                Cycle
                            </td>
                        ...
                        <tr>
                            ...
                            <td>
                                <input autocomplete="nope" type="text"
                                       ...
                                       id="loading"
                                       name="loading" placeholder="" value="{{old('loading')}}">
                            </td>
                            <td>
                                UnLoad (sec.)
                            </td>
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            <div class="row">
                                <div class="col-sm-12">
                                    <div class="form-group">
                                            <textarea class="form-control" name="result_pm" value="{{old('result_pm')}}"
