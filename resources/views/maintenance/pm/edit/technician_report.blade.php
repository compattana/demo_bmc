                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            @php
                                                $date = \Carbon\Carbon::createFromFormat('Y-m-d', $pm->date)->translatedFormat('d F Y');
                                            @endphp
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        <select class="form-control select2" multiple="multiple" disabled name="technician_id[]">
                                ...
                                <div class="col-sm-3">
                                    ...
                                    <div class="form-group text-center">
                                        <input autocomplete="nope" type="text"
                                               ...
                                               id="title" readonly
                                               name="title" placeholder=""
                                               value="{{$product->productSerial->serial_name}}">
                                        @error('title')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                ...
                                <div class="col-md-3">
                                    ...
                                    <div class="form-group">
                                        <input autocomplete="nope" type="text"
                                               ...
                                               id="car_no" readonly
                                               name="car_no" placeholder="" value=" {{$pm->car_no}}">
                                        @error('car_no')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-sm-3">
                                    ...
                                    <div class="form-group">
                                        <input autocomplete="nope" type="text"
                                               ...
                                               name="hour_used" placeholder="" value="{{$pm->hour_used}}">
                                        @error('hour_used')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-sm-3">
                                    <div class="form-group">
                                        ...
                                        <input autocomplete="nope" type="text"
                                               ...
                                               name="hour_load" placeholder="" value="{{$pm->hour_load}}">
                                        @error('hour_load')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input autocomplete="nope" type="text"
                                               ...
                                               name="prefilter" placeholder="" value="{{$pm->prefilter}}">
                                        @error('prefilter')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <label for="last_change_prefilter_date"> วันที่เปลี่ยนครั้งสุดท้าย
                                            <span
                                                class="text-danger">*</span>
                                            :</label>
                                        @if ($pm->last_change_prefilter_date == null )
                                            @php
                                                $last_change_prefilter_date = old('last_change_prefilter_date');
                                            @endphp
                                        @else
                                            @php
                                                $last_change_prefilter_date = Carbon\Carbon::createFromFormat('Y-m-d', $pm->last_change_prefilter_date)->translatedFormat('d F Y')
                                            @endphp
                                        @endif
                                        <input type="text"
                                               class="form-control form-control-sm datepicker text-center @error('last_change_prefilter_date') is-invalid @enderror"
                                               name="last_change_prefilter_date" readonly
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input autocomplete="nope" type="text"
                                               ...
                                               name="after_filter" placeholder="" value="{{$pm->after_filter}}">
                                        @error('after_filter')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <label for="last_change_after_filter_date"> วันที่เปลี่ยนครั้งสุดท้าย
                                            <span
                                                class="text-danger">*</span>
                                            :</label>
                                        @if ($pm->last_change_after_filter_date == null )
                                            @php
                                                $last_change_after_filter_date = old('last_change_after_filter_date');
                                            @endphp
                                        @else
                                            @php
                                                $last_change_after_filter_date = Carbon\Carbon::createFromFormat('Y-m-d', $pm->last_change_after_filter_date)->translatedFormat('d F Y')
                                            @endphp
                                        @endif
                                        <input type="text"
                                               class="form-control form-control-sm datepicker text-center @error('last_change_after_filter_date') is-invalid @enderror"
                                               name="last_change_after_filter_date" readonly
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group ">
                                                <label>
                                                    <div class="icheck-success d-inline">
                                                        <input type="checkbox" name="compressor_check" disabled
                                                               @if($pm->compressor_check=='1') checked @endif value="1"
                                                               id="compressor_check">
                                                ...
                                                <input autocomplete="nope" type="text"
                                                       ...
                                                       value="{{$pm->compressor_check_detail}}">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                            ...
                                            <div class="form-group clearfix">
                                                <div class="icheck-primary d-inline">
                                                    <input type="checkbox" name="compressor_other_check" disabled
                                                           @if($pm->compressor_other_check=='1') checked
                                            ...
                                            <div class="form-group clearfix">
                                                <div class="icheck-primary d-inline">
                                                    <input type="checkbox" name="dryer_other_check" disabled
                                                           @if($pm->dryer_other_check=='1') checked
                                                           @endif  value="1"
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12">
                                            ...
                                            <textarea class="form-control" name="detail" readonly
                                                      value="{{$pm->detail}}"
                                                      placeholder="" rows="3">{{$pm->detail}}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-4">
                                                ...
                                                <select class="form-control form-control-sm select2" disabled
                                                    ...
                                                    @if ($pm->normal_start_time == null )
                                                        @php
                                                            $normal_start_time_hour = old('normal_start_time_hour');
                                                        @endphp
                                                    @else
                                                        @php
                                                            $normal_start_time_hour = \Carbon\Carbon::createFromFormat('H:i:s', $pm->normal_start_time)->translatedFormat('H');
                                                        @endphp
                                                    @endif
                                                    @for($i=0;$i<24;$i++)
                                                        @php
                                            ...
                                            <div class="col-4">
                                                ...
                                                <select class="form-control form-control-sm select2" disabled
                                                    ...
                                                    @else
                                                        @php
                                                            $normal_start_time_minute = \Carbon\Carbon::createFromFormat('H:i:s', $pm->normal_start_time)->translatedFormat('i');
                                                        @endphp
                                                    @endif
                                                    @for($i=0;$i<60;$i++)
                                                        @php
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-4">
                                                ...
                                                <select class="form-control form-control-sm select2" disabled
                                                    ...
                                                    @if ($pm->normal_end_time == null )
                                                        @php
                                                            $normal_end_time_hour = old('normal_end_time_hour');
                                                        @endphp
                                                    @else
                                                        @php
                                                            $normal_end_time_hour = \Carbon\Carbon::createFromFormat('H:i:s', $pm->normal_end_time)->translatedFormat('H');
                                                        @endphp
                                                    @endif
                                            ...
                                            <div class="col-4">
                                                ...
                                                <select class="form-control form-control-sm select2" disabled
                                                    ...
                                                    @else
                                                        @php
                                                            $normal_end_time_minute = \Carbon\Carbon::createFromFormat('H:i:s', $pm->normal_end_time)->translatedFormat('i');;
                                                        @endphp
                                                    @endif
                                                    @for($i=0;$i<60;$i++)
                                                        @php
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="form-group">
                                        <input autocomplete="nope" type="text"
                                               ...
                                               value="{{$pm->total_normal_work_time}}">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-4">
                                                ...
                                                <select class="form-control form-control-sm select2" disabled
                                                    ...
                                                    @if ($pm->ot_start_time == null)
                                                        @php
                                                            $ot_start_time_hour = old('ot_start_time_hour');
                                                        @endphp
                                                    @else
                                                        @php
                                                            $ot_start_time_hour = \Carbon\Carbon::createFromFormat('H:i:s', $pm->ot_start_time)->translatedFormat('H');
                                                        @endphp
                                                    @endif
                                                    @for($i=0;$i<24;$i++)
                                                        @php
                                            ...
                                            <div class="col-4">
                                                ...
                                                <select class="form-control form-control-sm select2" disabled
                                                    ...
                                                    @else
                                                        @php
                                                            $ot_start_time_minute = \Carbon\Carbon::createFromFormat('H:i:s', $pm->ot_start_time)->translatedFormat('i');;
                                                        @endphp
                                                    @endif
                                                    @for($i=0;$i<60;$i++)
                                                        @php
                                        ...
                                        <div class="row ">
                                            ...
                                            <div class="col-4">
                                                ...
                                                <select class="form-control form-control-sm select2" disabled
                                                    ...
                                                    @if ($pm->ot_end_time == null)
                                                        @php
                                                            $ot_end_time_hour = old('ot_end_time_hour');
                                                        @endphp
                                                    @else
                                                        @php
                                                            $ot_end_time_hour = \Carbon\Carbon::createFromFormat('H:i:s', $pm->ot_end_time)->translatedFormat('H');
                                                        @endphp
                                                    @endif
                                                    @for($i=0;$i<24;$i++)
                                                        @php
                                            ...
                                            <div class="col-4">
                                                ...
                                                <select class="form-control form-control-sm select2" disabled
                                                    ...
                                                    @else
                                                        @php
                                                            $ot_end_time_minute = \Carbon\Carbon::createFromFormat('H:i:s', $pm->ot_end_time)->translatedFormat('i');;
                                                        @endphp
                                                    @endif
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="form-group">
                                        <input autocomplete="nope" type="text"
                                               ...
                                               name="travel_time" placeholder="" value="{{$pm->travel_time}}">
                                        @error('travel_time')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="form-group">
                                        <input autocomplete="nope" type="text"
                                               ...
                                               name="return_time" placeholder="" value="{{$pm->return_time}}">
                                        @error('return_time')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="form-group ">
                                        <label>
                                            <input type="radio" name="status" disabled
                                                   @if($pm->status==\App\Models\TechnicianReport::STATUS_FINISHED)  checked
                                                   @endif
                                        ...
                                        <label>
                                            <input type="radio" name="status" disabled
                                                   @if($pm->status==\App\Models\TechnicianReport::STATUS_UNFINISHED)  checked
                                                   @endif
        ...
        <div class="card card-warning card-outline">
            ...
            <div class="card-body">
                <div class="form-group">
                    <div class="col-md-12">
                        <img
                            src="@if(!empty($pm->getFirstMediaUrl('signed'))){{ $pm->getFirstMediaUrl('signed') }}@else {{ asset('/images/no-image.jpeg') }} @endif"
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                <div class="preview">
                                    <img
                                        src="@if(!empty($pm->getFirstMediaUrl('image'))){{ $pm->getFirstMediaUrl('image') }}@else {{ asset('/images/no-image.jpeg') }} @endif"
