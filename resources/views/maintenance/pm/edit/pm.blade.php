        ...
        <div class="row">
            <div class="col-md-3">
                ...
                <div class="form-group">
                    <input autocomplete="nope" type="text"
                        ...
                        readonly name="report_no" placeholder="" value="{{ $preventive->report_no }}">
                    @error('report_no')
            ...
            <div class="col-md-3">
                ...
                <div class="form-group">
                    <input autocomplete="nope" type="text"
                        ...
                        readonly name="title" placeholder=""
            ...
            <div class="col-md-3">
                ...
                <div class="form-group">
                    <input autocomplete="nope" type="text"
                        class="form-control form-control-sm @error('title') is-invalid @enderror" id="title"
                        readonly name="title" placeholder="" value="{{ $maintenance->agreement->code }}">
                    @error('title')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
        ...
        <div class="row">
            <div class="col-md-3">
                ...
                <div class="form-group">
                    <input autocomplete="nope" type="text"
                        ...
                        id="compressor_type" readonly name="compressor_type" placeholder=""
            ...
            <div class="col-sm-3">
                ...
                <div class="form-group text-center">
                    <input autocomplete="nope" type="text"
                        class="form-control form-control-sm @error('title') is-invalid @enderror" id="title"
                        readonly name="title" placeholder="" value="{{ $product->product->title }}">
                    @error('title')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
            ...
            <div class="col-sm-3">
                ...
                <div class="form-group text-center">
                    <input autocomplete="nope" type="text"
                        class="form-control form-control-sm @error('serial_name') is-invalid @enderror" id="serial_name"
                        readonly name="serial_name" placeholder="" value="{{ $product->productSerial->serial_name }}">
                    @error('serial_name')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                        ...
                        <tbody>
                            ...
                            @foreach ($preventive_items as $preventive_item)
                                <tr>
                                    ...
                                    <td>
                                        <input autocomplete="nope" type="text"
                                            class="form-control form-control-sm" readonly id="dbi"
                                            name="dbi[]" placeholder="" value="{{ $preventive_item->dbi }}">
                                    </td>
                                    <td>
                                        <input autocomplete="nope" type="text"
                                    ...
                                    <td>
                                        <input autocomplete="nope" type="text"
                                            ...
                                            id="dbc1" readonly name="dbc1[]" placeholder=""
                                            value="{{ $preventive_item->dbc1 }}">
                                    </td>
                                    <td>
                                        <input autocomplete="nope" type="text"
                                            class="form-control form-control-sm @error('dbm2') is-invalid @enderror"
                                            id="dbm2" readonly name="dbm2[]" placeholder=""
                                            value="{{ $preventive_item->dbm2 }}">
                                    </td>
                                    <td>
                                        <input autocomplete="nope" type="text"
                                            class="form-control form-control-sm @error('dbc2') is-invalid @enderror"
                                            id="dbc2" readonly name="dbc2[]" placeholder=""
                                            value="{{ $preventive_item->dbc2 }}">
                                    </td>
                                    <td>
                                        <input autocomplete="nope" type="text"
                                            class="form-control form-control-sm @error('pm_other') is-invalid @enderror"
                                            id="pm_other" readonly name="pm_other[]" placeholder=""
                                            value="{{ $preventive_item->pm_other }}">
                                    </td>
                                </tr>
                            @endforeach
                        </tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input autocomplete="nope" type="text"
                                            ...
                                            id="last_record_inspection" readonly name="last_record_inspection[]"
                                            placeholder="" value="{{ $inspection->last_record_inspection }}">
                                    </td>
                                    <td>
                                        <div class="clearfix">
                            ...
                            <tr>
                                ...
                                <td>
                                    <input autocomplete="nope" type="text"
                                        ...
                                        id="running" readonly name="running" placeholder=""
                                        value="{{ $preventive->running }}">
                                </td>
                                <td rowspan="2">
                                    Cycle
                                </td>
                                ...
                                <td>
                                    <input autocomplete="nope" type="text"
                                        ...
                                        id="load1" readonly name="load1" placeholder=""
                                        value="{{ $preventive->load1 }}">
                                </td>
                                <td>
                                    <input autocomplete="nope" type="text"
                                        class="form-control form-control-sm text-center @error('load2') is-invalid @enderror"
                                        id="load2" readonly name="load2" placeholder=""
                                        value="{{ $preventive->load2 }}">
                                </td>
                                <td>
                                    <input autocomplete="nope" type="text"
                                        class="form-control form-control-sm text-center @error('load3') is-invalid @enderror"
                                        id="load3" readonly name="load3" placeholder=""
                                        value="{{ $preventive->load3 }}">
                                </td>
                            </tr>
                            <tr>
                                <td>
                                ...
                                <td>
                                    <input autocomplete="nope" type="text"
                                        ...
                                        id="loading" readonly name="loading" placeholder=""
                                        value="{{ $preventive->loading }}">
                                </td>
                                <td>
                                    UnLoad (sec.)
                                </td>
                                <td>
                                    <input autocomplete="nope" type="text"
                                        ...
                                        id="unload1" readonly name="unload1" placeholder=""
                                        value="{{ $preventive->unload1 }}">
                                </td>
                                <td>
                                    <input autocomplete="nope" type="text"
                                        class="form-control form-control-sm text-center @error('unload2') is-invalid @enderror"
                                        id="unload2" readonly name="unload2" placeholder=""
                                        value="{{ $preventive->unload2 }}">
                                </td>
                                <td>
                                    <input autocomplete="nope" type="text"
                                        class="form-control form-control-sm text-center @error('unload3') is-invalid @enderror"
                                        id="unload3" readonly name="unload3" placeholder=""
                                        value="{{ $preventive->unload3 }}">
                                </td>
                            </tr>
                        </tbody>
                    </table>
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    <div class="row">
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                                <textarea class="form-control" name="filter_type" value="{{ $preventive_replacement->filter_type }}" placeholder=""
                                                    readonly rows="5">{{ $preventive_replacement->filter_type }}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    <div class="row">
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                                <textarea class="form-control" name="last_replacement" value="{{ $preventive_replacement->last_replacement }}"
                                                    placeholder="" readonly rows="5">{{ $preventive_replacement->last_replacement }}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    <div class="row">
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                                <textarea class="form-control" name="next_replacement" value="{{ $preventive_replacement->next_replacement }}"
                                                    readonly placeholder="" rows="5">{{ $preventive_replacement->next_replacement }}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            <div class="row">
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        <textarea class="form-control" name="result_pm" value="{{ $preventive->result_pm }}" readonly placeholder=""
                                            rows="3">{{ $preventive->result_pm }}</textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="form-group">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                <div class="preview">
                                    <img src="@if (!empty($preventive->getFirstMediaUrl('image'))) {{ $preventive->getFirstMediaUrl('image') }}@else {{ asset('/images/no-image.jpeg') }} @endif"
