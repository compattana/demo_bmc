            ...
            <div class="col-12">
                ...
                <div class="row invoice-info">
                        ...
                        <table class="table table-striped table-bordered text-center">
                            ...
                            @foreach($part_change_present as $present)
                                <tr>
                                    ...
                                    <td>
                                        <div class="border_bottom_dot">
                                            {{$present->productPart->title . '/ เลขที่อะไหล่: '
                                            .$present->productPart->part_no}}
                                        </div>
                        ...
                        <table class="table table-striped table-bordered text-center">
                            ...
                            @foreach($part_change_future as $future)
                                <tr>
                                    ...
                                    <td>
                                        <div class="border_bottom_dot">
                                            {{$future->productPart->title . '/ เลขที่อะไหล่: '
                                            .$future->productPart->part_no}}
                                        </div>
                                    </td>
                                    <td>
                                        <div class="border_bottom_dot">
                    ...
                    <div class="col-md-12 invoice-col text-center">
                        ทางลูกค้าได้รับสิ่งของตามรายการข้างบนนี้ จาก บริษัทบุญไทยแมชชีนเนอรี่ คอมเพล็กซ์
                ...
                <div class="row invoice-info">
                    ...
                    <div class="col-sm-6 invoice-col">
                        ...
                        <img
                            src="@if(!empty($maintenance_report->getFirstMediaUrl('image'))){{ $maintenance_report->getFirstMediaUrl('image') }}@else {{ asset('/images/no-image.jpeg') }} @endif"
