            ...
            <div class="col-md-6">
                <div class="card card-outline card-warning">
                    ...
                    <div class="card-body">
                        ...
                        <label for="organization_name">ชื่อบริษัท <span class="text-danger">*</span> </label>
                        ...
                        <label for="name">รหัสลูกค้า </label>
                        <div class="form-group">
                            <input autocomplete="nope" type="text"
                        ...
                        <div class="form-group">
                            <input autocomplete="nope" type="text"
                                   ...
                                   id="tax_number"
                                   name="tax_number" placeholder="" value="{{$customer->tax_number}}">
                            @error('tax_number')
                            <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            <input autocomplete="nope" type="text"
                                   ...
                                   id="tel"
                                   name="tel" placeholder="" value="{{$customer->tel}}">
                            @error('tel')
                            <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>

                        <label for="name">ที่อยู่ลูกค้า</label>
                        <div class="form-group">
                            <input autocomplete="nope" type="text"
                                   class="form-control form-control-sm @error('address') is-invalid @enderror"
                                   id="address"
                                   name="address" placeholder="" value="{{$customer->address}}">
                            @error('address')
                            <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="form-group">
                            <input autocomplete="nope" type="text"
                                   ...
                                   id="contact_name"
                                   name="contact_name" placeholder="" value="{{$customer->contact_name}}">
                            @error('contact_name')
                            <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>

                        <label for="contact_tel">เบอร์โทรผู้ติดต่อ</label>
                        <div class="form-group">
                            <input autocomplete="nope" type="text"
                                   class="form-control form-control-sm @error('contact_tel') is-invalid @enderror"
                                   id="contact_tel"
                                   name="contact_tel" placeholder="" value="{{$customer->contact_tel}}">
                            @error('contact_tel')
                            <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
