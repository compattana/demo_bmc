...
@section('title', 'อาการ Dryer - เพิ่มข้อมูล')

@section('content_header')
    <div class="row">
        <div class="col-sm-6">
            <h1 class="m-0 text-dark">
                <i class="fas fa-fw fa-cog"></i> เพิ่มข้อมูล
            </h1>
        </div>
        <div class="col-sm-6">
...
@section('content')
    <form action="{{route('dryers.store')}}" method="post" id="formStore" enctype="multipart/form-data">
        <div class="row">
            <div class="col-md-6">
                <div class="card">
                    @csrf
                        ...
                        <div class="form-group ">
                            <label>
                                <input type="radio" name="status" checked
                                       value="{{\App\Models\Dryer::STATUS_ACTIVE}}">
                                ใช้งาน
                            </label>
                            &emsp;
                            <label>
                                <input type="radio" name="status" value="{{\App\Models\Dryer::STATUS_INACTIVE}}">
                                ไม่ใช้งาน
                            </label>
                        </div>
